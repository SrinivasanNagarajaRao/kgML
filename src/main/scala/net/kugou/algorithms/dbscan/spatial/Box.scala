...
import net.kugou.algorithms.dbscan.{BoxId, DbscanSettings}
import net.kugou.algorithms.dbscan.util.math.DoubleComparisonOperations._
...
/** Represents a box-shaped region in multi-dimensional space
  ...
  */
private [dbscan] class Box (val bounds: Array[BoundsInOneDimension], val boxId: BoxId = 0,
                            val partitionId: Int = -1, var adjacentBoxes: List[Box] = Nil)
