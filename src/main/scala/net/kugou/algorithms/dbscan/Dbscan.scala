...
object Dbscan {
  ...
  /** Instantiates an object which implements the DBSCAN algorithm
    ...
    *                 [[net.kugou.algorithms.dbscan.DbscanSettings]] for details
  ...
  /** A convenience method which you can use to start clustering
    *
    * @param data     A [[net.kugou.algorithms.dbscan.RawDataSet]] which should be clustered
    * @param settings Parameters of the algorithm. See
    *                 [[net.kugou.algorithms.dbscan.DbscanSettings]] for details
    * @return A [[net.kugou.algorithms.dbscan.DbscanModel]] populated with information about clusters
    */
